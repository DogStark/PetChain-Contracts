...
#[cfg(test)]
mod test_certificate_lifecycle;
#[cfg(test)]
mod test_vet_credentials_expiry;
#[cfg(test)]
mod test_duration_arithmetic;
#[cfg(test)]
mod test_certificate_idempotency;
...
impl PetChainContract {
    ...
    */
    ...
    pub fn add_vaccination(
        ...
        Self::require_verified_vet(&env, &veterinarian);
    ...
    pub fn add_medical_record(
        ...
        vet_address.require_auth();
        Self::require_verified_vet(&env, &vet_address);
